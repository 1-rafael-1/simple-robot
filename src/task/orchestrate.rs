...
async fn handle_event(event: Events) {
    match event {
        ...
        Events::RotaryTurned(direction) => ui::try_send_ui_event(UiEvent::RotaryTurned(direction)),
        Events::RotaryButtonPressed => ui::try_send_ui_event(UiEvent::RotaryButtonPressed),
        Events::RotaryButtonHoldStart => ui::try_send_ui_event(UiEvent::RotaryButtonHoldStart),
        Events::RotaryButtonHoldEnd => ui::try_send_ui_event(UiEvent::RotaryButtonHoldEnd),
        Events::TestingCompleted => ui::try_send_ui_event(UiEvent::TestingCompleted),
        Events::CalibrationCompleted => ui::try_send_ui_event(UiEvent::CalibrationCompleted),
